...
public class BSTImpl<T extends Comparable<T>> implements BST<T> {
	...
	private int height (BSTNode<T> node, int count) {
		if (!node.isEmpty()) {
	...
	private BSTNode<T> maximumImpl (BSTNode<T> node) {
	...
	private BSTNode<T> minimumImpl(BSTNode<T> node) {
	...
	private void preOrderGenerate(ArrayList<T> list, BSTNode<T> node) {
		if (!node.isEmpty()) {
	...
	private void orderGenerate(ArrayList<T> list, BSTNode<T> node) {
		if (!node.isEmpty()) {
			orderGenerate(list, (BSTNode<T>) node.getLeft());
			list.add(node.getData());
			orderGenerate(list, (BSTNode<T>) node.getRight());
	...
	private void postOrderGenerate(ArrayList<T> list, BSTNode<T> node) {
		if (!node.isEmpty()) {
			orderGenerate(list, (BSTNode<T>) node.getLeft());
			orderGenerate(list, (BSTNode<T>) node.getRight());
			list.add(node.getData());
